...
(function (root, window, document, factory, undefined) {
    ...
    function initialise(containerSelector, options) {
        ...
        //     options['li' + 'cen' + 'seK' + 'e' + 'y']) || document.domain.indexOf('al' + 'varotri' + 'go' +
        //     '.' + 'com') > -1;
        ...
        function addVerticalNavigation() {
            ...
            for (var i = 0; i < $(SECTION_SEL).length; i++) {
                ...
                li += '<li><a href="#' + link + '"><span class="fp-sr-only">' + getBulletLinkName(i, 'Section') +
                    '</span><span></span></a>';
        ...
        function isDestinyTheStartingSection() {
            ...
            return !destinationSection || typeof destinationSection !== 'undefined' && index(destinationSection) ===
        ...
        */
        function touchMoveHandler(e) {
            ...
            if (isReallyTouch(e)) {
                ...
                if ($(SLIDES_WRAPPER_SEL, activeSection).length && Math.abs(touchStartX - touchEndX) > (Math.abs(
        ...
        function MouseWheelHandler(e) {
            ...
            if (options.autoScrolling && !controlPressed && !isNormalScroll) {
                ...
                var horizontalDetection = typeof e.wheelDeltaX !== 'undefined' || typeof e.deltaX !==
                    'undefined';
                var isScrollingVertically = (Math.abs(e.wheelDeltaX) < Math.abs(e.wheelDelta)) || (Math.abs(e.deltaX) <
                    Math.abs(e.deltaY) || !horizontalDetection);
        ...
        function scrollPage(element, callback, isMovementUp) {
            ...
            if ((v.activeSection == element && !isResizing) || (options.scrollBar && getScrollTop() === v.dtop &&
        ...
        function getEventData(eventName, v) {
            ...
            if (!options.v2compatible) {
                ...
                paramsPerEvent = {
                    ...
                    onSlideLeave: function () {
                        return [v.prevSlide, v.anchorLink, (v.sectionIndex + 1), v.prevSlideIndex, v.direction,
                            v.slideIndex];
                    },
                };
            }
        ...
        function addSlidesNavigation(section, numSlides) {
            ...
            for (var i = 0; i < numSlides; i++) {
                appendTo(createElementFromHTML('<li><a href="#"><span class="fp-sr-only">' + getBulletLinkName(
                    i, 'Slide') + '</span><span></span></a></li>'), $('ul', nav)[0]);
            }
        ...
        function displayWarnings() {
            ...
            var extensions = ['fadingEffect', 'continuousHorizontal', 'scrollHorizontally', 'interlockedSlides',
                'resetSliders', 'responsiveSlides', 'offsetSections', 'dragAndMove', 'scrollOverflowReset',
                'parallax'];
            if (hasClass($('html'), ENABLED)) {
                showError('error',
            ...
            options.anchors.forEach(function (name) {
                ...
                var nameAttr = [].slice.call($('[name]')).filter(function (item) {
                    return item.getAttribute('name') && item.getAttribute('name').toLowerCase() ==
                        name.toLowerCase();
                });
